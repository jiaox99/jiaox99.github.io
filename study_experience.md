...
现后来看了实时阴影的一些书，对游戏内阴影的渲染算是有了足够全面系统的了解
...
因为参与到的项目是一个多人对战的 FPS 游戏，需要添加一些机器人便于进行审核，开始想要系统地研究游戏 AI 的架构设计

之前的了解仅限于寻路、状态机、行为树

## 机器学习

随着世代的发展，现在各行各业数据越来越多，游戏业也不例外，而且现在硬件性能也越来越高，价格也相对更亲民了些，所以当下用机器学习对海量数据进行处理是趋势

搭建修改过一个本地的以图搜图应用

写过一个基于图像识别的游戏外挂程序

对其原理可谓了解，对各种框架、模型却不敢称精通